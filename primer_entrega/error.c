...
void error_print(int ne) {
	...
	case 3:
		printf(
				"\t Warning %d: falta comilla de cierre. la línea será consumida\n",
				ne);
		break;
	case 4:
		printf(
				"\t Warning %d: Identificador de mas de 8 caracteres, será truncado\n",
				ne);
		break;
	case 5:
	...
	case 6:
		printf(
				"\t Error %d: El número de argumentos no coincide. ucc programa.c \n",
				ne);
		break;
	case 7:
	...
	case 39:
		printf(
				"\t Error %d: El identificador debe ser una variable o parámetro\n",
				ne);
		break;
	case 40:
		printf(
				"\t Error %d: En una expresion, los arreglos deben ser accedidos por sus elementos\n",
				ne);
		break;
	case 41:
		printf("\t Error %d: Fin de archivo no valido\n", ne);
		break;
	case 42:
		printf("\t Error %d: Var. declarada como tipo arreglo. Falta [\n", ne);
		break;
	case 43:
		printf(
				"\t Error %d: Pasaje de parametro tipo arreglo. No se permiten []\n",
				ne);
		break;
	}
}
